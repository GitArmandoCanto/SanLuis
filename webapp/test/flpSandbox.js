		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "San Luis Field Division",
									"targetURL": "#sanluisnspsanluisproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sanluisnspsanluisproject-display": {
								"semanticObject": "sanluisnspsanluisproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sanluisnsp.sanluisproject",
									"url": sap.ui.require.toUrl("sanluisnsp/sanluisproject")
								}
							}
						}
					}
